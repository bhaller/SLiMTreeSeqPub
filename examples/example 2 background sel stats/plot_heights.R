...
quartz(width=5.5, height=2.75, type="pdf", file="dip.pdf")
par(mar=c(3.5, 3.5, 1, 1), family="serif", mgp=c(2.1, 0.6, 0))
plot(x=xr, y=yr, type="n", xlab="distance from gene", ylab="mean tree height (generations)", xaxp=c(xr,2), yaxp=c(yr,1))

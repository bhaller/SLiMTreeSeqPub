...
You will also need Python installed (version 3.4.8 or later is recommended), and you will need various Python packages installed such as msprime, pyslim, and matplotlib.  To produce the publication plots, you will need R installed (probably any version from 3.0 onward will be fine).

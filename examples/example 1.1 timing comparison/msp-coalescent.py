...
ts = msprime.simulate(sample_size=1000, Ne=500, length=float(args.Lstr), recombination_rate=1e-8, mutation_rate=1e-7)
ts.dump("./output/msp_L=" + args.Lstr + "_" + str(args.rep) + ".trees")
